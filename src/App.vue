  ...
  methods: {
    ...
    obtenerDatosPostres() {
      const respuesta = axios
        .get("https://apppostres.azurewebsites.net/api/v1/products")
        .then((response) => {
    ...
    async obtenerDatoPostre() {
      const respuesta = axios
        .get("https://apppostres.azurewebsites.net/api/v1/product/" + this.buscar)
        .then((response) => {
    ...
    borrarDatoPostre(id) {
      const respuesta = axios
        .delete("https://apppostres.azurewebsites.net/api/v1/product/" + id)
        .then((response) => {
    ...
    agregarDatoPostre() {
      if (
        ...
        if (this.editando === true) {
          ...
          let url = "https://apppostres.azurewebsites.net/api/v1/product/" + nuevoPostre.codigo;
          ...
          let url = "https://apppostres.azurewebsites.net/api/v1/product/";
